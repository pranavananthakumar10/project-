...
<body>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex ml-auto flex-column flex-lg-row align-items-center">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="watch.html"> Our Bags </a>
                </li>
                <li class="nav-item">
                  ...
                  <div class="row">
                    <div class="col-md-5">
                      <div class="slider_img-box">
                        <div>
                          <img src="images/bag-1.jpg" alt="" class="" />
                        </div>
                      </div>
                    </div>
                    <div class="col-md-7">
                      <div class="slider_item-detail">
                        <div>
                          ...
                          <p>
                            We provide Professional Stylish Bags for your corporate life.
                          </p>
                          <div class="d-flex">
  ...
  <section class="container-fluid footer_section">
    <p>
      ...
      <a href="https://html.design/" target="blank">Bags and More. </a>
    </p>
  </section>
  <!-- footer section -->
